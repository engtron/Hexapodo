...
//Impair Lift 10 deg   - indo para cima e dentro
  ...
  //Impair rote fwd 30 deg  -- indo para tras
  if (FM2 <= 30)
  {
  ...
  //Impair rotate bwd -30 deg  ---- para frente
  if (FM2 >= 30)
  {
...
// pata ----------------------  = - para fora e + para dentro
  ...
  if (Impair_start){
    ...
    //Pair rote fwd 30 deg -- indo para tras
    if (FM6 <= 30)
    {
    ...
    //Pair rotate bwd -30 deg  ---- para frente
    if (FM6 >= 30)
    {
